...
import org.opendaylight.yang.gen.v1.http.netconfcentral.org.ns.skeleton.rev150524.SendMessageInput;
...
import org.opendaylight.yang.gen.v1.http.netconfcentral.org.ns.skeleton.rev150524.SkeletonService;
...
public class ODLSkeletonImpl implements BindingAwareProvider, SkeletonService, AutoCloseable {
    ...
    public void onSessionInitiated(ProviderContext session) {
        ...
        rpcReg = session.addRpcImplementation(SkeletonService.class, this);
    ...
    private void initConfiguration() {
        // Build the default ODLSkeletonImpl config data
    ...
    public Future<RpcResult<java.lang.Void>> sendMessage(SendMessageInput input) {
        ...
        // Put the operational data into the MD-SAL data store
        WriteTransaction tx = dataService.newWriteOnlyTransaction();
        tx.put(LogicalDatastoreType.OPERATIONAL, Skeleton_ID, protocol);
